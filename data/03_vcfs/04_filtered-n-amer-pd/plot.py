...
#   plot-vcfstats -p /home/FCAM/cpugliese/lab_wns/05_vcfs/02_stats/03_only-pd/01_bcfplots/02_n-amer-pd n-amer-pd_bcftools_stats.vchk
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. n-ame .. /home/FCAM/cpugliese/lab_wns/05_vcfs/03_filtered-vcfs/n-amer-pd-only_filtered.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='n-ame')
    has_data = 1
