...
#   plot-vcfstats -p /home/FCAM/cpugliese/wns-lab/gvcfs/03_joint-calling/01_stats pd_bcftools_stats.vchk
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='pd')
    has_data = 1
