...
#   plot-vcfstats -p /home/FCAM/cpugliese/wns-lab/gvcfs/03_joint-calling/02_stats_ploidy-1 pd_ploidy-1_bcftools_stats.vchk
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. pd_pl .. pd_ploidy-1.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='pd_pl')
    has_data = 1
