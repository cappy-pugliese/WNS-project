...
INPUT_VCF=$1
NAME=$2
OUTPUT_DIR=/home/FCAM/cpugliese/lab_wns/05_vcfs/02_stats/03_only-pd/02_vcfstats/01_ploidy1
...
vcftools --gzvcf $INPUT_VCF --freq --out $OUTPUT_DIR/$NAME.allele_freq
