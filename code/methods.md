...
1. bams (andrius did everything before basically)
2. Call variants: **Haplotype caller**
3. Consolidate GVCFs: **GenomicsDBImport**
4. Joint-call Cohort: GenotypeGVCFs
    - set ploidy to 1
5. bcftools view (bcftools/1.9)
