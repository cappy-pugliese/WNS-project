...
OUTDIR=/home/FCAM/cpugliese/lab_wns/05_vcfs/03_filtered-vcfs/plink_files/06_plink-n-amer-no-clones/with-ld
OUTNAME=n-amer-no-clones_ploidy1_filtered_plink-ld
