...
BED=/home/FCAM/cpugliese/wns/02_raw-data/pd_data/pd_ref/pd_ref.bed
OUTDIR=/home/FCAM/cpugliese/lab_wns/08_pixy/01_n-amer-no-clones/07_by-year_scaffolds
PREFIX=n-amer-no-clones_by-year_scaffolds
